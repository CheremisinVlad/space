...
public class DirectoryTestData {
    ...
    public static Directory DIRECTORY1_VLAD = new Directory(DIRECTORY1_VLAD_ID,"patterns",USER_VLAD_ID,0,true);
    public static Directory DIRECTORY2_VLAD = new Directory(DIRECTORY2_VLAD_ID,"patterns",USER_VLAD_ID,DIRECTORY1_VLAD_ID,false);
