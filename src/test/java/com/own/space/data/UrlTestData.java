...
public class UrlTestData {
    ...
    public static Url createUrlWithNullValue() {
        return new Url(USER_VLAD_ID,DIRECTORY1_VLAD_ID,null,"it's null url");
    }
    public static Url createUrlWithInvalidValue() {
        return new Url(USER_VLAD_ID,DIRECTORY1_VLAD_ID,"it's incorrect url","it's null url");
    }

    public static Url createUrlWithDescriptionLessThenSize() {
        return new Url(USER_VLAD_ID,DIRECTORY1_VLAD_ID,"https://github.com","a");
    }

    public static Url createUrlWithDescriptionMoreThenSize() {
        return new Url(USER_VLAD_ID,DIRECTORY1_VLAD_ID,"https://github.com",RandomStringUtils.random(51,true,true));
    }
    public static Url createUrlWithNullDescription() {
        return new Url(USER_VLAD_ID,DIRECTORY1_VLAD_ID,"https://github.com",null);
    }

    public static Url createUrlWithNullParentId() {
        return new Url(USER_VLAD_ID,null,"https://github.com","alpha");
    }

    public static Url createUrlWithNullUserId() {
        return new Url(null,DIRECTORY1_VLAD_ID,"https://github.com","alpha");
    }

    public static Url createUrlWithNullIsMainFlag() {
        return new Url(USER_VLAD_ID,DIRECTORY1_VLAD_ID,"https://github.com","alpha");
    }
    ...
    public static Url createUrlWithFalseMainFlagAndParentIdZero() {
        return new Url(USER_VLAD_ID,0,"https://github.com","alpha");
    }
    ...
    public static Url updateUrl1ForVlad() {
        return new Url(URL1_VLAD_ID,USER_VLAD_ID,DIRECTORY1_VLAD_ID,"https://github.com","it's updated");
    }

    public static Url createNotExisted() {
        return new Url(1,DIRECTORY1_VLAD_ID,"https://github.com","alpha");
    }
}
